...
Score: 7/10 - Great work! Focus on the concepts above to improve.`)
  ...
  return (
    <div className="min-h-screen">
      {/* Hero Section */}
      <section className="relative flex items-center justify-center min-h-screen px-4 pt-12">
        {/* Background Elements */}
        ...
        <div className="container max-w-7xl mx-auto">
          <div className="text-center mb-16">
            <h2 className="text-3xl font-bold sm:text-4xl mb-4">
              See Our AI Tutor in Action
            </h2>
            <p className="text-muted-foreground text-lg max-w-2xl mx-auto">
              Discover how our platform transforms test analysis and provides personalized learning experiences
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 mb-12">
            {/* Input Stage */}
            <Card className="border-2 relative overflow-hidden group hover:shadow-xl transition-all duration-300">
              <div className="absolute top-4 right-4 bg-blue-500/20 text-blue-600 px-2 py-1 rounded-full text-xs font-medium">
                STEP 1
              </div>
              <CardHeader>
                <CardTitle className="text-xl text-center mb-4">Upload Test Paper</CardTitle>
                <div className="aspect-[3/4] bg-gradient-to-br from-blue-500/10 to-indigo-500/10 rounded-lg border-2 border-dashed border-blue-500/30 flex flex-col items-center justify-center p-4 group-hover:border-blue-500/50 transition-colors">
                  <BookOpen className="h-12 w-12 text-blue-500 mb-3" />
                  <p className="text-sm text-blue-600 font-medium mb-2">Physics Test Paper</p>
                  <p className="text-xs text-muted-foreground text-center">Multiple choice & written questions</p>
                  
                  {/* Sample test elements */}
                  <div className="w-full mt-4 space-y-2">
                    <div className="h-2 bg-blue-200/50 rounded w-3/4"></div>
                    <div className="h-2 bg-blue-200/50 rounded w-full"></div>
                    <div className="h-2 bg-blue-200/50 rounded w-2/3"></div>
                    <div className="flex justify-between items-center mt-3">
                      <div className="w-4 h-4 rounded-full bg-red-300/60"></div>
                      <div className="w-4 h-4 rounded-full bg-green-300/60"></div>
                      <div className="w-4 h-4 rounded-full bg-red-300/60"></div>
                      <div className="w-4 h-4 rounded-full bg-green-300/60"></div>
                    </div>
                  </div>
                ...
                <CardDescription className="text-center">
                  Upload your completed test paper from any exam board (Edexcel, CIE, AQA, etc.)
                </CardDescription>
              </CardHeader>
            </Card>
            ...
            {/* Processing Stage */}
            <Card className="border-2 relative overflow-hidden group hover:shadow-xl transition-all duration-300">
              <div className="absolute top-4 right-4 bg-green-500/20 text-green-600 px-2 py-1 rounded-full text-xs font-medium">
                STEP 2
              </div>
              <CardHeader>
                <CardTitle className="text-xl text-center mb-4">AI Analysis</CardTitle>
                <div className="aspect-[3/4] bg-gradient-to-br from-green-500/10 to-emerald-500/10 rounded-lg border-2 border-dashed border-green-500/30 flex flex-col items-center justify-center p-4 group-hover:border-green-500/50 transition-colors">
                  <div className="relative">
                    <Brain className="h-12 w-12 text-green-500 mb-3 animate-pulse" />
                    <div className="absolute -top-2 -right-2 w-6 h-6 bg-green-400 rounded-full flex items-center justify-center">
                      <CheckCircle className="h-3 w-3 text-white" />
                    </div>
                  </div>
                  <p className="text-sm text-green-600 font-medium mb-2">Processing Questions</p>
                  <p className="text-xs text-muted-foreground text-center mb-4">Comparing with mark schemes</p>
                  
                  {/* Processing visualization */}
                  <div className="w-full space-y-3">
                    <div className="flex items-center space-x-2">
                      <div className="w-2 h-2 bg-green-400 rounded-full animate-pulse"></div>
                      <div className="h-1 bg-green-200 rounded flex-1">
                        <div className="h-1 bg-green-400 rounded w-3/4 animate-pulse"></div>
                      </div>
                    </div>
                    <div className="flex items-center space-x-2">
                      <div className="w-2 h-2 bg-blue-400 rounded-full animate-pulse delay-300"></div>
                      <div className="h-1 bg-blue-200 rounded flex-1">
                        <div className="h-1 bg-blue-400 rounded w-2/3 animate-pulse delay-300"></div>
                      </div>
                    </div>
                    <div className="flex items-center space-x-2">
                      <div className="w-2 h-2 bg-purple-400 rounded-full animate-pulse delay-500"></div>
                      <div className="h-1 bg-purple-200 rounded flex-1">
                        <div className="h-1 bg-purple-400 rounded w-4/5 animate-pulse delay-500"></div>
                      </div>
                    </div>
                  </div>
                </div>
                <CardDescription className="text-center">
                  Our AI analyzes each question against official mark schemes and identifies key areas
                </CardDescription>
              </CardHeader>
            </Card>
            ...
            {/* Output Stage */}
            <Card className="border-2 relative overflow-hidden group hover:shadow-xl transition-all duration-300">
              <div className="absolute top-4 right-4 bg-purple-500/20 text-purple-600 px-2 py-1 rounded-full text-xs font-medium">
                STEP 3
              </div>
              <CardHeader>
                <CardTitle className="text-xl text-center mb-4">Personalized Feedback</CardTitle>
                <div className="aspect-[3/4] bg-gradient-to-br from-purple-500/10 to-pink-500/10 rounded-lg border-2 border-dashed border-purple-500/30 flex flex-col items-center justify-center p-4 group-hover:border-purple-500/50 transition-colors">
                  <div className="relative">
                    <GraduationCap className="h-12 w-12 text-purple-500 mb-3" />
                    <div className="absolute -top-2 -right-2 w-6 h-6 bg-purple-400 rounded-full flex items-center justify-center">
                      <span className="text-white text-xs font-bold">B+</span>
                    </div>
                  </div>
                  <p className="text-sm text-purple-600 font-medium mb-2">Detailed Report</p>
                  <p className="text-xs text-muted-foreground text-center mb-4">Score: 78/100 (B+ Grade)</p>
                  
                  {/* Feedback visualization - consistent with other cards */}
                  <div className="w-full space-y-3">
                    <div className="flex items-center space-x-2">
                    ...
                    <div className="flex items-center space-x-2">
                      ...
                      <div className="h-1 bg-red-200 rounded flex-1">
                        <div className="h-1 bg-red-400 rounded w-3/5"></div>
                      </div>
                      <span className="text-xs text-red-600 font-medium">62%</span>
                    </div>
                    <div className="flex items-center space-x-2">
                      <div className="w-2 h-2 bg-blue-400 rounded-full"></div>
                      <div className="h-1 bg-blue-200 rounded flex-1">
                        <div className="h-1 bg-blue-400 rounded w-7/10"></div>
                      </div>
                      <span className="text-xs text-blue-600 font-medium">71%</span>
                    </div>
                    
                    {/* Study tip indicator */}
                    <div className="mt-2 flex items-center justify-center">
                      <div className="w-3 h-3 bg-yellow-400 rounded-full animate-pulse"></div>
                      <div className="ml-2 text-xs text-yellow-600 font-medium">Study recommendations ready</div>
                    </div>
                  </div>
                </div>
                <CardDescription className="text-center">
                  Get detailed explanations, corrections, and personalized study recommendations
                </CardDescription>
              </CardHeader>
            </Card>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            <Card className="border-2 hover:shadow-lg transition-shadow">
              <CardHeader>
                ...
                <div className="aspect-[4/3] bg-gradient-to-br from-orange-500/5 to-yellow-500/5 rounded-lg border border-orange-200 p-4 flex flex-col justify-center">
                  <div className="space-y-3">
                    <div className="flex items-start space-x-3">
                      <div className="w-6 h-6 bg-red-100 rounded-full flex items-center justify-center flex-shrink-0">
                        <span className="text-xs text-red-600">Q1</span>
                      </div>
                      <div className="flex-1">
                        <p className="text-sm text-muted-foreground">Incorrect answer detected</p>
                        <p className="text-xs text-red-600 mt-1">Missing key physics principle</p>
                      </div>
                    </div>
                    <div className="flex items-start space-x-3">
                      <div className="w-6 h-6 bg-green-100 rounded-full flex items-center justify-center flex-shrink-0">
                        <span className="text-xs text-green-600">Q2</span>
                      </div>
                      <div className="flex-1">
                        <p className="text-sm text-muted-foreground">Perfect answer!</p>
                        <p className="text-xs text-green-600 mt-1">Well explained methodology</p>
                      </div>
                    </div>
                  </div>
                </div>
                <CardDescription>
                  Deep dive into each question with specific feedback and explanations
                </CardDescription>
              </CardHeader>
            </Card>
            ...
            <Card className="border-2 hover:shadow-lg transition-shadow">
              <CardHeader>
                <div className="flex items-center space-x-3 mb-4">
                  ...
                  <CardTitle className="text-lg">Learning Path Recommendations</CardTitle>
                </div>
                <div className="aspect-[4/3] bg-gradient-to-br from-teal-500/5 to-cyan-500/5 rounded-lg border border-teal-200 p-4 flex flex-col justify-center">
                  <div className="space-y-3">
                    <div className="flex items-center space-x-3">
                      ...
                      <div>
                        <p className="text-sm font-medium">Recommended Topics</p>
                        <p className="text-xs text-muted-foreground">Heat transfer equations</p>
                      </div>
                    </div>
                    <div className="flex items-center space-x-3">
                      ...
                      <div>
                        ...
                        <p className="text-xs text-muted-foreground">Similar problems to solve</p>
                      </div>
                    </div>
                  </div>
                </div>
                <CardDescription>
                  Get personalized study plans and targeted practice recommendations
                </CardDescription>
              </CardHeader>
            </Card>
          </div>
